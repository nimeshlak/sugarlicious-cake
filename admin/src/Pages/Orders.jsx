...
import parcel from '../assets/admin_assets/parcel_icon.jpeg'
...
const Orders = ({token}) => {
  ...
  const fetchAllOrders = async () => {
    ...
    try {
      const response = await axios.post('https://sugarlicious-cake-backend.vercel.app/api/order/list', {}, { headers: { token } })
